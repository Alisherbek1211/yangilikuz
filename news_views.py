...
def all_news_view():
    ...
    if term:
        ...
        for single_news in all_news:
            single_news.title = highlight_words(single_news.title, term, "<span style='background-color: yellow; font-weight: bold; color: black;'>", "</span>")
            single_news.content = highlight_words(single_news.content, term, "<span style='background-color: yellow; font-weight: bold; color: black;'>", "</span>")
